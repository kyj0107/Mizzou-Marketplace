...
cur.execute("INSERT INTO items (itemName, itemDescription, poster) VALUES (?, ?, ?)", ("Nightstand", "A simple nightstand.", "Karla Jaime"))
cur.execute("INSERT INTO items (itemName, itemDescription, poster) VALUES (?, ?, ?)", ("Chemistry Textbook", "That one textbook with the chemistry pun in the credits.", "Jordan Andersen"))
cur.execute("INSERT INTO items (itemName, itemDescription, poster) VALUES (?, ?, ?)", ("Apple MacBook Pro 16-inch", "This MacBook has seen some things.", "Daniel Thompson"))
